...
export class AllVendorComponent implements OnInit {
  constructor(private vendorService: GenericService) { }
  ...
  color = 'accent';
  mode = 'indeterminate';
  vendorRespList: VendorMaster[];

  // getVendorList() {
  //   const path = '/vendor/vendor-list';
  //   this.vendorService.getAll(path).subscribe(data => {
  //     this.vendorRespList = data;
  //     this.isLoadingResults = false;
  //   }, err => {
  //     console.log(err);
  //     console.log('vendor: ' + err.message);
  //   });
  // }
